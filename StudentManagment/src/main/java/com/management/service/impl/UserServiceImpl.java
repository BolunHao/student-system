...
import java.util.Map;
    ...
    public class UserServiceImpl extends ServiceImpl<UserMapper,User> implements UserService{
        ...
        public Object login(User u, HttpSession session, HttpServletRequest request) {
            ...
            loginLog.setLoginTotal(LoginlogServiceImpl.findMaxLoginTotalByUserId(user.getId())); // Total number of logins
            ...
            if (user.getFirstlogin() == null || user.getFirstlogin()) {
                // Set the first-time login flag bit to false
                user.setFirstlogin(false);
                // Updating user information
                super.updateById(user);
                // Return to tips
                return ResultUtil.result(EnumCode.OK.getValue(), "This is your first time logging in. Please change your password and check your personal information.");
            }
